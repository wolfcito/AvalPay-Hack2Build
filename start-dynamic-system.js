...
console.log('🚀 Iniciando eERC System (Modo Dinámico)...\n');
...
// Función principal
async function startDynamicSystem() {
  try {
    ...
    // Iniciar backend dinámico
    console.log('🚀 Iniciando backend (modo dinámico)...');
    const backend = spawn('npm', ['run', 'dynamic'], {
    ...
    console.log('📡 Backend: http://localhost:3001 (modo dinámico)');
    console.log('🌐 Frontend: http://localhost:3000');
    console.log('\n🔧 Características del modo dinámico:');
    console.log('   • Scripts modificados en tiempo real');
    console.log('   • Montos personalizables');
    console.log('   • Direcciones de MetaMask dinámicas');
    console.log('   • Operaciones reales de Hardhat');
